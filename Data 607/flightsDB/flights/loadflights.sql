...
LOAD DATA LOCAL INFILE  'E:\\Box Sync\\CUNY\\Fall 2017\\Data 607\\flightsDB\\flights\\airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA LOCAL INFILE 'E:\\Box Sync\\CUNY\\Fall 2017\\Data 607\\flightsDB\\flights\\airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'E:\\Box Sync\\CUNY\\Fall 2017\\Data 607\\flightsDB\\flights\\flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'E:\\Box Sync\\CUNY\\Fall 2017\\Data 607\\flightsDB\\flights\\planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'E:\\Box Sync\\CUNY\\Fall 2017\\Data 607\\flightsDB\\flights\\weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
