...
1.  What does a streak length of 1 mean, i.e. how many hits and misses are in a 
    ...
    Streak length of 1 means any sequence with H M, but no H immediately before this occuring.
    Streak length of 0 means any sequence with M, but with M immediately before this occuring.
...
Kobe's streak was typically 0.  His longest streak was 4. 
...
3.  In your simulation of flipping the unfair coin 100 times, how many flips 
    ...
    22 came up as heads.  (This value might change every time I run this program)
```{r}
...
-   Describe the distribution of streak lengths. What is the typical streak 
    ...
    0 is the most frequent streak length with increasing streak becoming less frequent.  4 is the longest streak.
...
-   If you were to run the simulation of the independent shooter a second time, 
    ...
    Somewhat similar since 133 is a decent number of cases for similar distribution to take place again.
...
-   How does Kobe Bryant's distribution of streak lengths compare to the 
    ...
    The distribution looks similar and this indicates that the Kobe does not have hot hand.  
