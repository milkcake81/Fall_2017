...
There is an increase in the number of girls baptized over the years.
...
The propotion of boys remains similiar throughout the time.  
...
No, in the 1900s, the record for baptism is in the millions
```{r}
summary(arbuthnot)
summary(present)
```
...
-   Make a plot that displays the boy-to-girl ratio for every year in the data 
    ...
    There are slightly more boys being borned than girls in the U.S.
...
-   In what year did we see the most total number of births in the U.S.? You can
    ...
    1961 is the year with the max number of births. 
