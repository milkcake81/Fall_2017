...
-   Note that normal probability plots C and D have a slight stepwise pattern.  
    ...
    Plot D: The stepwise pattern comes from the fact that age is integers and there's no number in between age.  
    Plot C: Elbow diameter is rounded to first decimal points so there's still some stepwise pattern.
